...
WebUI.click(findTestObject('retailer_creation_Storecreation/Page_AppCohesion/a_Stores              Stores'))

WebUI.click(findTestObject('retailer_creation_Storecreation/Page_AppCohesion/i_'))

WebUI.setText(findTestObject('retailer_creation_Storecreation/Page_AppCohesion/input_STORE NAME_name'), findTestData('storename').getValue(
        1, 1))
