...
not_run: WebUI.selectOptionByValue(findTestObject('Object Repository/Appco Login/store repo/select_All'), '66', true)

WebUI.selectOptionByLabel(findTestObject('Object Repository/Appco Login/store repo/select_All'), 'New Retailer KatalonAuto', 
    true)
...
WebUI.uploadFile(findTestObject('retailer admin All Repo/store_object_repo/FFL_doc'), 'C:\\sample_doc\\sample.pdf', FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('retailer admin All Repo/store_object_repo/check_default_store'), 10)
...
WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/storeeditbutton'), FailureHandling.STOP_ON_FAILURE)
