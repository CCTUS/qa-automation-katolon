...
WebUI.verifyElementVisible(findTestObject('Object Repository/AddToCartStoreAdmin/Page_AppCohesion/div_Ruger Lower Receiver AR (1)'))

WebUI.click(findTestObject('Object Repository/AddToCartStoreAdmin/Page_AppCohesion/div_Ruger Lower Receiver AR (1)'))

WebUI.delay(4)

WebUI.click(findTestObject('Object Repository/AddToCartStoreAdmin/Page_AppCohesion/button_ADD TO CART (1)'))
