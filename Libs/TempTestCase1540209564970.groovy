...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\order_placement_order_details\\Retailer Markup\\20181022_172924\\execution.properties')
...
not_run: WebUI.setText(findTestObject('retailer admin All Repo/inventory retailer markup repo/searchProduct markup'), 'RUGER-UCSR7GCZ')

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/inventory retailer markup repo/search markup icon'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/inventory retailer markup repo/search markup icon'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/inventory retailer markup repo/product listed'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/inventory retailer markup repo/add_markupvalue_input'))

not_run: WebUI.setText(findTestObject('retailer admin All Repo/inventory retailer markup repo/add_markupvalue_input'), '12.8')

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/inventory retailer markup repo/add_markup button'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/inventory retailer markup repo/add_markup button'))

not_run: WebUI.waitForAlert(10)

not_run: WebUI.verifyMatch('Markup updated successfully.', 'Markup updated successfully.', true, FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.setText(findTestObject('retailer admin All Repo/inventory retailer markup repo/common search product'), 'RUGER-UCSR7GCZ')
...
not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/Search Products Details/Page_AppCohesion/td_Ruger LC LCP'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('retailer admin All Repo/Search Products Details/Page_AppCohesion/td_Ruger LC LCP'), 
...
WebUI.verifyElementText(findTestObject('Object Repository/retailer admin All Repo/inventory retailer markup repo/Page_AppCohesion/Page_AppCohesion/span_Base Price180.00'), 
    'Base Price$180.00')
