...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\gogo car\\gogocar_usecase_common search\\20181108_154635\\execution.properties')
...
WebUI.setText(findTestObject('gogo user journey/new use case_common search/input_(optional)_UserEmail'), 'testnew@mailinator.com')
...
WebUI.setText(findTestObject('gogo user journey/new use case_common search/input__userCity'), 'New Albany')

WebUI.verifyElementPresent(findTestObject('gogo user journey/new use case_common search/label_Present Zip'), 2)

WebUI.setText(findTestObject('gogo user journey/new use case_common search/input__zipcode'), '47150')
