...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_210224\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/button_EDIT PROFILE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/button_EDIT PROFILE'))
