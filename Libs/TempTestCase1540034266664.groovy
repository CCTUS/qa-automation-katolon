...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_164746\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/Edit profile (1)'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('retailer admin All Repo/menu list/Edit profile (1)'))
