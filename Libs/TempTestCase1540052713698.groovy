...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_215513\\execution.properties')
...
WebUI.waitForElementVisible(findTestObject('retailer admin All Repo/menu list/Preferred Distributor'), 90, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('retailer admin All Repo/menu list/Preferred Distributor'), 30)
