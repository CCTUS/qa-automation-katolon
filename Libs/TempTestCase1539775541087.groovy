...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Retailer_Store_managment\\Retailer_store_creation_edit_delete\\20181017_165541\\execution.properties')
...
not_run: WebUI.click(findTestObject('retailer_creation_Storecreation/Page_AppCohesion/a_Dashboard              Dashb'))

not_run: WebUI.waitForPageLoad(0)

not_run: WebUI.click(findTestObject('store_object_repo/store_tab'))

not_run: WebUI.verifyElementVisible(findTestObject('store_object_repo/store_container'))

not_run: WebUI.click(findTestObject('store_object_repo/store_container'))

not_run: WebUI.verifyElementVisible(findTestObject('store_object_repo/storeeditbutton'))

not_run: WebUI.click(findTestObject('store_object_repo/storeeditbutton'))

not_run: WebUI.setText(findTestObject('store_object_repo/store_name'), 'New Store creation')

not_run: String ts1 = System.currentTimeMillis().toString()

not_run: WebUI.setText(findTestObject('store_object_repo/FFL_no'), ts1)
...
not_run: WebUI.verifyElementVisible(findTestObject('store_object_repo/store_update_button'))

not_run: WebUI.click(findTestObject('store_object_repo/store_update_button'))
