...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_211128\\execution.properties')
...
WebUI.mouseOver(findTestObject('retailer admin All Repo/menu list/menuopen (1)'))

WebUI.click(findTestObject('retailer admin All Repo/menu list/My profile option'))

WebUI.waitForPageLoad(50)

WebUI.dragAndDropToObject(findTestObject('retailer admin All Repo/menu list/Edit profile button'), findTestObject('retailer admin All Repo/menu list/Edit profile button'))
