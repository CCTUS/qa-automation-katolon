...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_162259\\execution.properties')
...
not_run: WebUI.verifyElementVisible(findTestObject('Object Repository/menu list/Edit profile'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('Object Repository/menu list/Edit profile'))
...
not_run: WebUI.verifyElementVisible(findTestObject('menu list/Rule'))

not_run: WebUI.click(findTestObject('menu list/Rule'))

not_run: WebUI.verifyElementVisible(findTestObject('menu list/Preferred Distributor'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('menu list/Preferred Distributor'))

not_run: WebUI.verifyElementVisible(findTestObject('menu list/check appco'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('menu list/check appco'))

not_run: WebUI.verifyElementVisible(findTestObject('menu list/Preferred Distributor'))

not_run: WebUI.click(findTestObject('menu list/Preferred Distributor'))

not_run: WebUI.verifyElementVisible(findTestObject('menu list/distance'))

not_run: WebUI.click(findTestObject('menu list/distance'))

WebUI.verifyElementVisible(findTestObject('menu list/opt check distance'), FailureHandling.CONTINUE_ON_FAILURE)
