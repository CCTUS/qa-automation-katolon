...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\Menu_profile_rule_change_pwd\\20181022_115006\\execution.properties')
...
not_run: WebUI.waitForPageLoad(90)
...
WebUI.mouseOver(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor (1)'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/menu list/shipping cost'))

WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor (1)'), 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor (1)'))
...
''', 'Test Cases/RetailerAdmin_Login_All_Functionality/Menu list/Menu_profile_rule_change_pwd', new TestCaseBinding('Test Cases/RetailerAdmin_Login_All_Functionality/Menu list/Menu_profile_rule_change_pwd',[:]), FailureHandling.STOP_ON_FAILURE , false)
