...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin\\order_placement_order_details\\Retailer  add Markup order placement\\20190103_162325\\execution.properties')
...
not_run: WebUI.click(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h5_Sig Sauer Nitron Full Size _2'))

not_run: WebUI.delay(5)

not_run: WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/span_Retailer Markup34.56'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/strong_34.56'))

not_run: WebUI.verifyElementText(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/strong_34.56'), 
    '34.56%')

not_run: WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/span_Amount Payable571.87'))

not_run: WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/strong_571.87'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/a_Back to Cart'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/a_Back to Cart'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/div_571.87_cart-item-removeBut'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/button_CHECKOUT'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/button_CHECKOUT'))

not_run: WebUI.delay(5)

not_run: WebUI.setText(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/input_FIRST NAME_firstName'), 
    'order SGSAR-2YH5ZDI7')

not_run: WebUI.setText(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/input_EMAIL_email'), 
    'snekalatha.r@iinerds.com')

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/div_Order Summary      Order I'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h5_Sig Sauer(1item) x 571.87'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h5_Shipping Cost25'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h5_Amount Payable            5'), 
    FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/div_Shipping Info'), 
    FailureHandling.CONTINUE_ON_FAILURE)
