...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Retailer_Store_managment\\Retailer_store_creation_edit_delete\\20181023_170344\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/store_object_repo/Page_AppCohesion/h5_Success  Store has been del'))

WebUI.verifyElementText(findTestObject('Object Repository/retailer admin All Repo/store_object_repo/Page_AppCohesion/h5_Success  Store has been del'), 
    'Success: Store has been deleted successfully.Existing users for the store assigned to default store')
