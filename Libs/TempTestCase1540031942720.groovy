...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_160902\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/label_ROLE'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/h4_RACreation RACreation'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/h4_RETAILER ADMIN'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_AppCohesion/h4_RETAILER ADMIN'), 'RETAILER ADMIN')

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/label_RETAILER NAME'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/button_EDIT PROFILE'))

WebUI.click(findTestObject('Object Repository/Page_AppCohesion/button_EDIT PROFILE'))
