...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\gogo car\\gogocar_usecase_common search\\20181109_164012\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('Page_GoGoCar/ul_                           '), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('gogo user journey/new use case_common search/oppointment_schedule/Page_GoGoCar/input_Time required_form-contr'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.dragAndDropToObject(findTestObject('Object Repository/gogo user journey/new use case_common search/Page_GoGoCar/input__form-control text-cente'), 
