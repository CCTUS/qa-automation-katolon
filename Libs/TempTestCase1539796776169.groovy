...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Retailer_Employee_management\\employee_Creation_edit_delete\\20181017_224936\\execution.properties')
...
not_run: WebUI.click(findTestObject('employee_obj_repo/Page_AppCohesion/li_NewRetailerKatalonNewRetail'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('employee_obj_repo/emp_edit_button'))
...
not_run: WebUI.waitForAlert(0)

WebUI.click(findTestObject('employee_obj_repo/retailer_employeeview/Page_AppCohesion/collapsible-header_Retailer Ad'))

WebUI.click(findTestObject('employee_obj_repo/Page_AppCohesion/li_NewRetailerKatalonNewRetail'), FailureHandling.STOP_ON_FAILURE)
