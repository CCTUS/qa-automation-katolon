...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\LMP\\LMP_Draft_Product_new\\20190717_113940\\execution.properties')
...
not_run: WebUI.click(findTestObject('LMP Draft_Product/button_Product Category_sf_btn_search'))
...
not_run: WebUI.verifyElementVisible(findTestObject('LMP Draft_Product/h5_Creating Draft Listing...'), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.selectOptionByValue(findTestObject('Object Repository/LMP Draft_Product/select_Select your StorefrontA'), 
    '50', true, FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.delay(3)

not_run: WebUI.selectOptionByValue(findTestObject('LMP Draft_Product/select_Select your Listing Sta'), 'All', true, FailureHandling.CONTINUE_ON_FAILURE)
...
''', 'Test Cases/LMP/LMP_Draft_Product_new', new TestCaseBinding('Test Cases/LMP/LMP_Draft_Product_new',[:]), FailureHandling.STOP_ON_FAILURE , false)
