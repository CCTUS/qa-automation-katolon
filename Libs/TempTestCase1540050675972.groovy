...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_212115\\execution.properties')
...
not_run: WebUI.dragAndDropToObject(findTestObject('retailer admin All Repo/menu list/Edit profile button'), findTestObject(
        'retailer admin All Repo/menu list/Edit profile button'))
