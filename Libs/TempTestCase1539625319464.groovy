...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\retaileradmin_order_placement\\20181015_231159\\execution.properties')
...
not_run: WebUI.dragAndDropToObject(findTestObject('retailer_order_placement/Page_AppCohesion/i_Settings_glyphicon glyphicon'), 
    findTestObject('retailer_order_placement/Page_AppCohesion/i_Settings_glyphicon glyphicon'))
...
not_run: WebUI.dragAndDropToObject(findTestObject('retailer_order_placement/Page_AppCohesion/input_Shopping Cart_sizecb'), 
    findTestObject('retailer_order_placement/Page_AppCohesion/input_Shopping Cart_sizecb'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('retailer_order_placement/Page_AppCohesion/input_Shopping Cart_sizecb'), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('Object Repository/retailer_order_placement/Page_AppCohesion/span_534.20'))

not_run: WebUI.click(findTestObject('Object Repository/retailer_order_placement/Page_AppCohesion/span_25.00'))

not_run: WebUI.click(findTestObject('Object Repository/retailer_order_placement/Page_AppCohesion/em_Item selected 1'))

not_run: WebUI.rightClick(findTestObject('Object Repository/retailer_order_placement/Page_AppCohesion/input_Quantity_quant1'))
...
not_run: WebUI.verifyElementVisible(findTestObject('retailer_order_placement/Page_AppCohesion/span_VIEW ORDERS'))
...
not_run: WebUI.dragAndDropToObject(findTestObject('retailer_order_placement/Page_AppCohesion/i__glyphicon glyphicon-search'), 
    findTestObject('retailer_order_placement/Page_AppCohesion/i__glyphicon glyphicon-search'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer_order_placement/Page_AppCohesion/i__glyphicon glyphicon-search'), 
    FailureHandling.CONTINUE_ON_FAILURE)
