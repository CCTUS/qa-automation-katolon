...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_165831\\execution.properties')
...
WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/Edit profile button'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('retailer admin All Repo/menu list/Edit profile button'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/label_ROLE'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/h4_RACreation RACreation'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_AppCohesion/h4_RETAILER ADMIN'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/menuopen (1)'))

WebUI.click(findTestObject('retailer admin All Repo/menu list/menuopen (1)'))

WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/Rule'))

WebUI.click(findTestObject('retailer admin All Repo/menu list/Rule'))
