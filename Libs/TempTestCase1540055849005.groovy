...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DELL\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\My profile\\20181020_224728\\execution.properties')
...
not_run: WebUI.switchToWindowIndex(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/div_RULE SETTINGS'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/menu list/shipping cost'))

WebUI.check(findTestObject('retailer admin All Repo/menu list/shipping cost'))
