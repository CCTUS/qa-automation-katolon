...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Menu list\\Menu_profile_rule_change_pwd\\20181022_113526\\execution.properties')
...
WebUI.mouseOver(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/menu list/shipping cost'))

WebUI.verifyElementPresent(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor'), 
    50)
...
WebUI.click(findTestObject('retailer admin All Repo/menu list/Page_AppCohesion/Page_AppCohesion/h4_Preferred Distributor'))
