...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin\\Add Inventory\\20190606_115330\\execution.properties')
...
WebUI.scrollToElement(findTestObject('Retailer creation/inventory_object repo/new inventory object Repo/button_Save Distributor Settin'), 
    10)
...
WebElement element = WebUiCommonHelper.findWebElement(findTestObject('Object Repository/Retailer creation/inventory_object repo/new inventory object Repo/button_Save Distributor Settin'), 
    30)

//JavascriptExecutor jse2 = ((driver) as JavascriptExecutor)
JavascriptExecutor jse1 = ((driver) as JavascriptExecutor)

jse1.executeScript('window.scrollTo(0,0)', element)
...
WebUI.click(findTestObject('Object Repository/Retailer creation/inventory_object repo/new inventory object Repo/button_Add Distributor Invento'))
