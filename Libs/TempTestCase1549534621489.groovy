...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin\\Menu list\\rule_search_distributor\\20190207_154701\\execution.properties')
...
not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/rule object repo/td_Ruger LC LCP'), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('retailer admin All Repo/rule object repo/td_Ruger LC LCP'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/rule object repo/distributor_header'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/rule object repo/distributorname_id'))

not_run: WebUI.verifyElementText(findTestObject('retailer admin All Repo/rule object repo/distributorname_id'), 'Ellett Brothers')
