...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\LMP\\LMP_Draft_Product\\20190211_132818\\execution.properties')
...
WebUI.selectOptionByValue(findTestObject('LMP Draft_Product/select_Select your StorefrontA'), '50', true)

WebUI.selectOptionByValue(findTestObject('LMP Draft_Product/select_Select your Listing Sta'), 'All', true)

WebUI.click(findTestObject('LMP Draft_Product/button_Search (1)'))

WebUI.click(findTestObject('Object Repository/LMP Draft_Product/input_Drafted Date_innerTdChec'))

WebUI.verifyElementVisible(findTestObject('Page_AppCohesion/button_Delete Listing'))

WebUI.click(findTestObject('Object Repository/LMP Draft_Product/button_Delete Listing'))
