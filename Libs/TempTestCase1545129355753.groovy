...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin\\order_placement_order_details\\Retailer  add Markup order placement\\20181218_160555\\execution.properties')
...
not_run: WebUI.callTestCase(findTestCase('Call Test Case/Login_retailer_testcase_markup'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/button_ADD TO CART'))

WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h4_Only 23 left in stock'))

WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/span_23'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/div_Success  Markup updated su'))

WebUI.verifyElementText(findTestObject('Page_AppCohesion/h5_Success  Markup updated suc'), 'Success:  Markup updated successfully.')
...
WebUI.rightClick(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/h5_Sig Sauer Nitron Full Size'))
...
WebUI.verifyElementText(findTestObject('Page_AppCohesion/span_571.87'), '$571.87')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/input_Shopping Cart_sizecb'))

WebUI.click(findTestObject('Object Repository/retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/input_Shopping Cart_sizecb'))
...
WebUI.rightClick(findTestObject('retailer admin All Repo/retailer_order_placement/Retailer markup and Order placement/button_CHECKOUT'))
