...
RunConfiguration.setExecutionSettingFile('C:\\Users\\SNEKAL~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\RetailerAdmin_Login_All_Functionality\\Retailer_Store_managment\\Retailer_store_creation_edit_delete\\20181023_170817\\execution.properties')
...
not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/h5_Success  Store created succ'))

not_run: WebUI.verifyElementText(findTestObject('retailer admin All Repo/store_object_repo/h5_Success  Store created succ'), 
...
not_run: WebUI.waitForElementVisible(findTestObject('retailer admin All Repo/store_object_repo/store_update_button'), 100)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/store_update_button'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/store_object_repo/store_update_button'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/alert_proceed'))

not_run: WebUI.click(findTestObject('retailer admin All Repo/store_object_repo/alert_proceed'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/h5_Success  Store details upda'))

not_run: WebUI.verifyElementText(findTestObject('retailer admin All Repo/store_object_repo/h5_Success  Store details upda'), 
    'Success: Store details updated.')

not_run: WebUI.waitForPageLoad(0)

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/store_container0'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/default store container'))

not_run: WebUI.verifyElementVisible(findTestObject('retailer admin All Repo/store_object_repo/store_container1'))
...
not_run: WebUI.verifyElementText(findTestObject('retailer admin All Repo/store_object_repo/h5_Success  Your default store'), 
    'Success: Your default store option changed')
